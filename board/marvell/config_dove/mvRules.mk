...
HAL_SYS_DIR	       = $(SRC_PATH)/mv_hal_sys
...
# HAL components
HAL_AC97_DIR       = $(HAL_DIR)/ac97
HAL_DRAM_DIR       = $(HAL_DIR)/ddr
...
HAL_PEX_DIR        = $(HAL_DIR)/pci-if/pex
...
HAL_PATH           = -I$(HAL_DIR) -I$(HAL_SYS_DIR) -I$(HAL_SATA_CORE_DIR)
COMMON_PATH        = -I$(COMMON_DIR) 
OSSERVICES_PATH    = -I$(OSSERVICES_DIR)
USP_PATH           = -I$(USP_DIR)
SOC_PATH	       = -I$(ORION_FAM_DIR) -I$(SOC_DIR) -I$(SOC_SYS_DIR) -I$(SOC_ENV_DIR) -I$(SOC_CPU_DIR) -I$(SOC_DEVICE_DIR) -I$(CONFIG_DIR)

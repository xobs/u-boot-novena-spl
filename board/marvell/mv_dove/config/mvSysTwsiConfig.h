...
*/
#define MV_TWSI_SLAVE_REGS_BASE(unit) 	(MV_TWSI_SLAVE_REGS_OFFSET(unit) + INTER_REGS_BASE)

/*
** Specific definition for Main CPU interrupt cause register.
** Needed for TWSI operation completion monitoring.
*/
#define MV_TWSI_CPU_MAIN_INT_CASUE	(TWSI_CPU_MAIN_INT_CAUSE_REG + INTER_REGS_BASE)

...
DRAMREGS_CUBOX_UNIFIED = ./tools/doimage_dove/dramregs/dramregs_cubox.txt
	...
	ifeq ($(SPI_BOOT), y)
		...
		ifeq ($(DRAM),HYNIX_CUBOX)	
			DO_IMAGE = ./tools/doimage -T flash -D 0x600000 -E 0x650000 \
				-R $(DRAMREGS_CUBOX_UNIFIED) u-boot.bin u-boot-$(MV_OUTPUT)_hynix_cubox_unified$(MV_NAND_GANG_MODE)_spi.bin; \

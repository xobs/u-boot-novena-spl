...
DRAMREGS_CUBOX_512MB = ./tools/doimage_dove/dramregs/dramregs_cubox_512mb.txt
	...
	ifeq ($(SPI_BOOT), y)
		...
		ifeq ($(DRAM),HYNIX_CUBOX)	
			DO_IMAGE = ./tools/doimage -T flash -D 0x600000 -E 0x650000 \
                                -R $(DRAMREGS_CUBOX_512MB) u-boot.bin u-boot-$(MV_OUTPUT)_hynix_cubox_512MB$(MV_NAND_GANG_MODE)_spi.bin; \
			...
			DO_IMAGE_UART = ./tools/doimage -T uart -D 0x600000 -E 0x650000 \
                                -R $(DRAMREGS_CUBOX_512MB) u-boot.bin u-boot-$(MV_OUTPUT)_hynix_cubox_512MB$(MV_NAND_GANG_MODE)_uart.bin; \
